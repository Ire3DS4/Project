...
from part1 import CentralRegistry  
...
@app.route('/')  # homepage
def index_page():
    r = CentralRegistry().returnregistry()  # the part that guides the program to the correct output
    l = CentralRegistry().returnlinks()  # to shorten links and not use CentralRegistry 
